...
mod_default_config(){
    ...
    echo '[MOD] 修改主机名为 XLBox'
    sed -i 's/OpenWrt/XLBox/w /dev/stdout' package/base-files/files/bin/config_generate
...
CONFIG_TARGET_ROOTFS_PARTSIZE=88
